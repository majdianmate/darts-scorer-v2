...
const SignIn = () => {
  ...
  const { signInWithCredentials, signInOrSignUpWithGoogle } = useAuthentication();
  ...
  return (
    <div className="mx-auto w-full max-w-sm bg-background rounded-lg shadow-lg p-10">
        ...
        <form onSubmit={handleEmailLogin} className="mt-4 space-y-2.5">
          <div>
            <Label
        ...
        <p className="text-pretty mt-3 text-xs text-muted-foreground flex justify-center">
          ...
          <Link to="/sign-up" className="text-primary cursor-pointer ml-1">
            Sign up
          </Link>
        </p>
      </div>
